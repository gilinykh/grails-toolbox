<%@ page import="ru.gramant.grails.toolbox.FeedEntry" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: feedEntryInstance, field: 'description', 'error')} ">
				<label for="description" class="control-label"><g:message code="feedEntry.description.label" default="Description" /></label>
				<div class="controls">
			...
			<div class="control-group fieldcontain ${hasErrors(bean: feedEntryInstance, field: 'categories', 'error')} ">
				<label for="categories" class="control-label"><g:message code="feedEntry.categories.label" default="Categories" /></label>
				<div class="controls">
					<g:select name="categories" from="${ru.gramant.grails.toolbox.FeedCategory.list()}" multiple="multiple" optionKey="id" size="5" value="${feedEntryInstance?.categories*.id}" class="many-to-many"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: feedEntryInstance, field: 'feed', 'error')} required">
				<label for="feed" class="control-label"><g:message code="feedEntry.feed.label" default="Feed" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<g:select id="feed" name="feed.id" from="${ru.gramant.grails.toolbox.Feed.list()}" optionKey="id" required="" value="${feedEntryInstance?.feed?.id}" class="many-to-one"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: feedEntryInstance, field: 'publishedDate', 'error')} required">
				<label for="publishedDate" class="control-label"><g:message code="feedEntry.publishedDate.label" default="Published Date" /><span class="required-indicator">*</span></label>
				<div class="controls">
			...
			<div class="control-group fieldcontain ${hasErrors(bean: feedEntryInstance, field: 'type', 'error')} required">
				<label for="type" class="control-label"><g:message code="feedEntry.type.label" default="Type" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<g:select name="type" from="${ru.gramant.grails.toolbox.ResourceType?.values()}" keys="${ru.gramant.grails.toolbox.ResourceType.values()*.name()}" required="" value="${feedEntryInstance?.type?.name()}"/>
