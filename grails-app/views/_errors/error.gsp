  ...
  <body>
	...
	<section id="overview" class="">
    	<div class="alert alert-error">
			${request.'javax.servlet.error.message' ? (request.'javax.servlet.error.message'.indexOf(':') == null ? request.'javax.servlet.error.message'.encodeAsHTML()	: request.'javax.servlet.error.message'.substring(0, request.'javax.servlet.error.message'.indexOf(':')).encodeAsHTML()) : 'unknown'}
			<g:if test="${exception}">
				${exception.className}
